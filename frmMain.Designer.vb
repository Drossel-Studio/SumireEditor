...
#Region "Windows フォーム デザイナによって生成されたコード "
    ...
    Public WithEvents mnuFileOpenDirectory As ToolStripMenuItem
    Public WithEvents mnuLineFile As ToolStripSeparator
    Public WithEvents _mnuRecentFiles_0 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_1 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_2 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_3 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_4 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_5 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_6 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_7 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_8 As ToolStripMenuItem
    Public WithEvents _mnuRecentFiles_9 As ToolStripMenuItem
    Public WithEvents mnuLineRecent As ToolStripSeparator
    Public WithEvents mnuFileConvertWizard As ToolStripMenuItem
    Public WithEvents mnuLineExit As ToolStripSeparator
    ...
    Public WithEvents mnuLineEdit1 As ToolStripSeparator
    Public WithEvents mnuEditCut As ToolStripMenuItem
    Public WithEvents mnuEditCopy As ToolStripMenuItem
    Public WithEvents mnuEditPaste As ToolStripMenuItem
    Public WithEvents mnuEditDelete As ToolStripMenuItem
    Public WithEvents mnuLineEdit2 As ToolStripSeparator
    Public WithEvents mnuEditSelectAll As ToolStripMenuItem
    Public WithEvents mnuLineEdit3 As ToolStripSeparator
    Public WithEvents mnuEditFind As ToolStripMenuItem
    Public WithEvents mnuLineEdit4 As ToolStripSeparator
    Public WithEvents _mnuEditMode_0 As ToolStripMenuItem
    Public WithEvents _mnuEditMode_1 As ToolStripMenuItem
    Public WithEvents _mnuEditMode_2 As ToolStripMenuItem
    Public WithEvents mnuEdit As ToolStripMenuItem
    Public WithEvents _mnuViewItem_0 As ToolStripMenuItem
    Public WithEvents _mnuViewItem_1 As ToolStripMenuItem
    Public WithEvents _mnuViewItem_2 As ToolStripMenuItem
    Public WithEvents mnuView As ToolStripMenuItem
    Public WithEvents _mnuOptionsItem_0 As ToolStripMenuItem
    Public WithEvents _mnuOptionsItem_1 As ToolStripMenuItem
    Public WithEvents _mnuOptionsItem_2 As ToolStripMenuItem
    Public WithEvents _mnuOptionsItem_3 As ToolStripMenuItem
    Public WithEvents _mnuOptionsItem_4 As ToolStripMenuItem
    Public WithEvents _mnuOptionsItem_5 As ToolStripMenuItem
    Public WithEvents _mnuOptionsItem_6 As ToolStripMenuItem
    Public WithEvents _mnuOptionsItem_7 As ToolStripMenuItem
    Public WithEvents mnuLineOptions As ToolStripSeparator
    Public WithEvents _mnuLanguage_0 As ToolStripMenuItem
    Public WithEvents _mnuLanguage_1 As ToolStripMenuItem
    Public WithEvents _mnuLanguage_2 As ToolStripMenuItem
    Public WithEvents mnuLanguageParent As ToolStripMenuItem
    Public WithEvents _mnuTheme_0 As ToolStripMenuItem
    Public WithEvents _mnuTheme_1 As ToolStripMenuItem
    Public WithEvents _mnuTheme_2 As ToolStripMenuItem
    Public WithEvents mnuThemeParent As ToolStripMenuItem
    Public WithEvents mnuOptions As ToolStripMenuItem
    Public WithEvents mnuToolsPlayAll As ToolStripMenuItem
    Public WithEvents mnuToolsPlay As ToolStripMenuItem
    Public WithEvents mnuToolsPlayStop As ToolStripMenuItem
    Public WithEvents mnuLineTools As ToolStripSeparator
    Public WithEvents mnuToolsSetting As ToolStripMenuItem
    Public WithEvents mnuTools As ToolStripMenuItem
    Public WithEvents mnuHelpOpen As ToolStripMenuItem
    Public WithEvents mnuLineHelp As ToolStripSeparator
    Public WithEvents mnuHelpWeb As ToolStripMenuItem
    Public WithEvents mnuHelpAbout As ToolStripMenuItem
    Public WithEvents mnuHelp As ToolStripMenuItem
    Public WithEvents mnuContextPlayAll As ToolStripMenuItem
    Public WithEvents mnuContextPlay As ToolStripMenuItem
    Public WithEvents mnuContextBar1 As ToolStripSeparator
    Public WithEvents mnuContextInsertMeasure As ToolStripMenuItem
    Public WithEvents mnuContextDeleteMeasure As ToolStripMenuItem
    Public WithEvents mnuContextBar2 As ToolStripSeparator
    Public WithEvents mnuContextEditCut As ToolStripMenuItem
    Public WithEvents mnuContextEditCopy As ToolStripMenuItem
    Public WithEvents mnuContextEditPaste As ToolStripMenuItem
    Public WithEvents mnuContextEditDelete As ToolStripMenuItem
    Public WithEvents mnuContext As ContextMenuStrip
    Public WithEvents mnuContextListLoad As ToolStripMenuItem
    Public WithEvents mnuContextListDelete As ToolStripMenuItem
    Public WithEvents mnuContextListRename As ToolStripMenuItem
    Public WithEvents mnuContextList As ContextMenuStrip
    Public WithEvents MainMenu1 As MenuStrip
    Public WithEvents Mode As ToolStripStatusLabel
    Public WithEvents Position As ToolStripStatusLabel
    Public WithEvents WAV As ToolStripStatusLabel
    Public WithEvents BMP As ToolStripStatusLabel
    Public WithEvents Measure As ToolStripStatusLabel
    Public WithEvents _staMain_Panel6 As ToolStripStatusLabel
    Public WithEvents staMain As StatusStrip
    Public WithEvents picSiromaru As PictureBox
    Public WithEvents tmrEffect As Timer
    Public WithEvents cboVScroll As ComboBox
    Public WithEvents lblVScroll As Label
    Public WithEvents fraResolution As Panel
    Public WithEvents cboDispHeight As ComboBox
    Public WithEvents cboDispWidth As ComboBox
    Public WithEvents lblDispWidth As Label
    Public WithEvents lblDispHeight As Label
    Public WithEvents fraDispSize As Panel
    Public WithEvents cboViewer As ComboBox
    Public WithEvents fraViewer As Panel
    Public WithEvents tmrMain As Timer
    Public WithEvents ilsMenu As ImageList
    Public WithEvents cboDirectInput As ComboBox
    Public WithEvents cmdDirectInput As Button
    Public WithEvents cboDispGridMain As ComboBox
    Public WithEvents cboDispGridSub As ComboBox
    Public WithEvents lblGridSub As Label
    Public WithEvents lblGridMain As Label
    Public WithEvents fraGrid As Panel
    Public WithEvents cboPlayer As ComboBox
    Public WithEvents txtGenre As TextBox
    Public WithEvents txtTitle As TextBox
    Public WithEvents txtArtist As TextBox
    Public WithEvents cboPlayLevel As ComboBox
    Public WithEvents txtBPM As TextBox
    Public WithEvents lblPlayMode As Label
    Public WithEvents lblGenre As Label
    Public WithEvents lblTitle As Label
    Public WithEvents lblArtist As Label
    Public WithEvents lblPlayLevel As Label
    Public WithEvents lblBPM As Label
    Public WithEvents _fraTop_0 As Panel
    Public WithEvents cboPlayRank As ComboBox
    Public WithEvents txtTotal As TextBox
    Public WithEvents txtVolume As TextBox
    Public WithEvents txtStageFile As TextBox
    Public WithEvents cmdLoadStageFile As Button
    Public WithEvents cmdLoadMissBMP As Button
    Public WithEvents txtMissBMP As TextBox
    Public WithEvents lblPlayRank As Label
    Public WithEvents lblTotal As Label
    Public WithEvents lblVolume As Label
    Public WithEvents lblStageFile As Label
    Public WithEvents lblMissBMP As Label
    Public WithEvents _fraTop_1 As Panel
    Public WithEvents cboDispFrame As ComboBox
    Public WithEvents cboDispSC2P As ComboBox
    Public WithEvents cboDispSC1P As ComboBox
    Public WithEvents cboDispKey As ComboBox
    Public WithEvents lblDispFrame As Label
    Public WithEvents lblDispSC2P As Label
    Public WithEvents lblDispSC1P As Label
    Public WithEvents lblDispKey As Label
    Public WithEvents _fraTop_2 As Panel
    Public WithEvents _optChangeTop_0 As RadioButton
    Public WithEvents _optChangeTop_2 As RadioButton
    Public WithEvents _optChangeTop_1 As RadioButton
    Public WithEvents fraHeader As Panel
    Public WithEvents _optChangeBottom_0 As RadioButton
    Public WithEvents _optChangeBottom_1 As RadioButton
    Public WithEvents _optChangeBottom_2 As RadioButton
    Public WithEvents _optChangeBottom_3 As RadioButton
    Public WithEvents _optChangeBottom_4 As RadioButton
    Public WithEvents txtExInfo As TextBox
    Public WithEvents _fraBottom_4 As Panel
    Public WithEvents cmdSoundExcUp As Button
    Public WithEvents cmdSoundExcDown As Button
    Public WithEvents cmdSoundDelete As Button
    Public WithEvents cmdSoundLoad As Button
    Public WithEvents cmdSoundStop As Button
    Public WithEvents lstWAV As ListBox
    Public WithEvents _fraBottom_0 As Panel
    Public WithEvents cmdBMPExcDown As Button
    Public WithEvents cmdBMPExcUp As Button
    Public WithEvents lstBMP As ListBox
    Public WithEvents cmdBMPDelete As Button
    Public WithEvents cmdBMPLoad As Button
    Public WithEvents cmdBMPPreview As Button
    Public WithEvents _fraBottom_1 As Panel
    Public WithEvents cmdBGAExcDown As Button
    Public WithEvents cmdBGAExcUp As Button
    Public WithEvents txtBGAInput As TextBox
    Public WithEvents cmdBGAPreview As Button
    Public WithEvents cmdBGASet As Button
    Public WithEvents cmdBGADelete As Button
    Public WithEvents lstBGA As ListBox
    Public WithEvents _fraBottom_2 As Panel
    Public WithEvents cboNumerator As ComboBox
    Public WithEvents cboDenominator As ComboBox
    Public WithEvents cmdMeasureSelectAll As Button
    Public WithEvents cmdInputMeasureLen As Button
    Public WithEvents lstMeasureLen As ListBox
    Public WithEvents lblFraction As Label
    Public WithEvents _fraBottom_3 As Panel
    Public WithEvents fraMaterial As Panel
    Public WithEvents picMain As PictureBox
    Public WithEvents hsbMain As HScrollBar
    Public WithEvents vsbMain As VScrollBar
    Public dlgMainOpen As OpenFileDialog
    Public dlgMainSave As SaveFileDialog
    Public WithEvents _New As ToolStripButton
    Public WithEvents Open As ToolStripDropDownButton
    Public WithEvents Reload As ToolStripButton
    Public WithEvents Save As ToolStripButton
    Public WithEvents SaveAs As ToolStripButton
    Public WithEvents SepMode As ToolStripSeparator
    Public WithEvents Edit As ToolStripButton
    Public WithEvents Write As ToolStripButton
    Public WithEvents Delete As ToolStripButton
    Public WithEvents SepViewer As ToolStripSeparator
    Public WithEvents Viewer As ToolStripSeparator
    Public WithEvents PlayAll As ToolStripButton
    Public WithEvents Play As ToolStripButton
    Public WithEvents _Stop As ToolStripButton
    Public WithEvents SepGrid As ToolStripSeparator
    Public WithEvents ChangeGrid As ToolStripSeparator
    Public WithEvents SepSize As ToolStripSeparator
    Public WithEvents DispSize As ToolStripSeparator
    Public WithEvents SepResolution As ToolStripSeparator
    Public WithEvents Resolution As ToolStripSeparator
    Public WithEvents tlbMenu As ToolStrip
    Public WithEvents lblDirectInput As Label
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'staMain
        '
        Me.staMain.ImageScalingSize = New System.Drawing.Size(24, 24)
        ...
        Me.lstBMP.Size = New System.Drawing.Size(213, 148)
        ...
        Me.lstMeasureLen.Size = New System.Drawing.Size(213, 148)
